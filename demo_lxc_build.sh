...
then	# Si le conteneur existe déjà
	ynh_print_info --message="> Suppression du conteneur existant." | tee -a "$LOG_BUILD_LXC" 2>&1
	/bin/bash "$final_path/demo_lxc_destroy.sh" quiet | tee -a "$LOG_BUILD_LXC" 2>&1
fi

ynh_print_info --message="> Création d'une machine debian $DIST minimaliste" | tee -a "$LOG_BUILD_LXC" 2>&1
ynh_lxc_create --image="$lxc_base" --name="$lxc_name1" | tee -a "$LOG_BUILD_LXC" 2>&1

ynh_print_info --message= "> Active le bridge réseau" | tee -a "$LOG_BUILD_LXC" 2>&1
lxc network attach $lxdbr_demo_name $lxc_name1 eth1 eth1 | tee -a "$LOG_BUILD_LXC" 2>&1

ynh_print_info --message="> Configuration réseau de la machine virtualisée" | tee -a "$LOG_BUILD_LXC" 2>&1
...
ynh_print_info --message="> Update de la machine virtualisée" | tee -a "$LOG_BUILD_LXC" 2>&1
...
ynh_print_info --message="> Ajout de l'utilisateur de demo" | tee -a "$LOG_BUILD_LXC" 2>&1
...
ynh_print_info --message="> Vérification de l'état de Yunohost" | tee -a "$LOG_BUILD_LXC" 2>&1
ynh_lxc_run_inside --name="$lxc_name1" --command="yunohost -v" | tee -a "$LOG_BUILD_LXC" 2>&1

# ********
ynh_print_info --message="> Modification de Yunohost pour la demo" | tee -a "$LOG_BUILD_LXC" 2>&1

if [ ${FOR_PACKAGE_CHECK:-0} -eq 1 ]; then
# App officielles
ynh_print_info --message="> Installation des applications officielles" | tee -a "$LOG_BUILD_LXC" 2>&1
# Ampache
ynh_print_info --message="Installation de Ampache" | tee -a "$LOG_BUILD_LXC" 2>&1
...
# Baikal
ynh_print_info --message="Installation de baikal" | tee -a "$LOG_BUILD_LXC" 2>&1
...
# Dokuwiki
ynh_print_info --message="Installation de dokuwiki" | tee -a "$LOG_BUILD_LXC" 2>&1
...
# Etherpad
ynh_print_info --message="Installation de etherpad" | tee -a "$LOG_BUILD_LXC" 2>&1
...
# Hextris
ynh_print_info --message="Installation de hextris" | tee -a "$LOG_BUILD_LXC" 2>&1
...
# Jirafeau
ynh_print_info --message="Installation de jirafeau" | tee -a "$LOG_BUILD_LXC" 2>&1
...
# Kanboard
ynh_print_info --message="Installation de kanboard" | tee -a "$LOG_BUILD_LXC" 2>&1
...
# Nextcloud
ynh_print_info --message="Installation de nextcloud" | tee -a "$LOG_BUILD_LXC" 2>&1
...
# Opensondage
ynh_print_info --message="Installation de opensondage" | tee -a "$LOG_BUILD_LXC" 2>&1
...
# Phpmyadmin
ynh_print_info --message="Installation de phpmyadmin" | tee -a "$LOG_BUILD_LXC" 2>&1
...
# Piwigo
ynh_print_info --message="Installation de piwigo" | tee -a "$LOG_BUILD_LXC" 2>&1
...
# Rainloop
ynh_print_info --message="Installation de rainloop" | tee -a "$LOG_BUILD_LXC" 2>&1
...
# Roundcube
ynh_print_info --message="Installation de roundcube" | tee -a "$LOG_BUILD_LXC" 2>&1
...
# Searx
ynh_print_info --message="Installation de searx" | tee -a "$LOG_BUILD_LXC" 2>&1
...
# Shellinabox
ynh_print_info --message="Installation de shellinabox" | tee -a "$LOG_BUILD_LXC" 2>&1
...
# Strut
ynh_print_info --message="Installation de strut" | tee -a "$LOG_BUILD_LXC" 2>&1
...
# Transmission
ynh_print_info --message="Installation de transmission" | tee -a "$LOG_BUILD_LXC" 2>&1
...
# Ttrss
ynh_print_info --message="Installation de ttrss" | tee -a "$LOG_BUILD_LXC" 2>&1
...
# Wallabag
ynh_print_info --message="Installation de wallabag" | tee -a "$LOG_BUILD_LXC" 2>&1
...
# Wordpress
ynh_print_info --message="Installation de wordpress" | tee -a "$LOG_BUILD_LXC" 2>&1
...
# Zerobin
ynh_print_info --message="Installation de zerobin" | tee -a "$LOG_BUILD_LXC" 2>&1
